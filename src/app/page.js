...
function MyApp({ Component, pageProps }) {
  ...
  return (
    ...
    {[
        ...
        { href: "/beltcoin", src: "/beltcoin.png", title: "BeltCoin", desc: "BeltCoin is a revolutionary WEB3 startup with a vision to restore and preserve the Earths ecosystem while fostering bio diversity. The core focus is safeguarding keystone
species within aquatic environments." },
